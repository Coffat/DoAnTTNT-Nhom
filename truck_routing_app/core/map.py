...
class Map:
    ...
    @classmethod
    def create_demo_map(cls, size=10):
        """
        Tạo một bản đồ mẫu với các mẫu đường đi, trạm xăng, trạm thu phí và vật cản
        được thiết kế sẵn.
        
        Args:
            size (int): Kích thước của bản đồ (mặc định: 10)
            
        Returns:
            Map: Đối tượng Map với bản đồ mẫu đã được thiết kế
        """
